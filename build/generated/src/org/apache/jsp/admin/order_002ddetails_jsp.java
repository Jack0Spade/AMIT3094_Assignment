...
public final class order_002ddetails_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 out.print(staff != null ? staff.getEmail() : "" );
      ...
      out.write("\n");
      out.write("                    ");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "/admin/GetOrdersProduct", out, false);
      out.write("\n");
      out.write("                    ");
      ...
      out.write("                                                    <input type=\"hidden\" name=\"order-id\" value=\"");
      out.print( order.getOrderId());
      out.write("\">\n");
      out.write("                                                    <div class=\"card-inner\">\n");
      out.write("                                                        <div class=\"nk-block\">\n");
      out.write("                                                            <div class=\"nk-block-head d-flex justify-between\">\n");
      out.write("                                                                <h5 class=\"title\">Order Details</h5>\n");
      out.write("                                                                ");
      ...
      out.write("\n");
      out.write("                                                                <div>\n");
      out.write("                                                                    <button type=\"button\" onclick=\"completeOrder()\" class=\"btn btn-success ms-2\">Complete</button>\n");
      out.write("                                                                    <button type=\"button\" onclick=\"delOrder()\" class=\"btn btn-danger ms-2\">Delete</button>\n");
      out.write("                                                                </div>\n");
      out.write("                                                                ");
}
      out.write("\n");
      ...
      out.write("                                                                <div class=\"col-3 d-flex flex-column align-center\">\n");
      out.write("                                                                    <span class=\"profile-ud-label\">Total</span>\n");
      out.write("                                                                    <span class=\"profile-ud-value\">");
      out.print( order.getPaymentId().getAmount());
      out.write(" MYR</span>\n");
      out.write("                                                                </div>\n");
      out.write("                                                                <div class=\"col-3 d-flex flex-column align-center\">\n");
      out.write("                                                                    <span class=\"profile-ud-label\">Date Ordered</span>\n");
      out.write("                                                                    <span class=\"profile-ud-value\">");
      out.print( outputDateStr);
      out.write("</span>\n");
      out.write("                                                                </div>\n");
      out.write("                                                                <div class=\"col-3 d-flex flex-column align-center\">\n");
      out.write("                                                                    <span class=\"profile-ud-label\">Payment Method</span>\n");
      out.write("                                                                    <span class=\"profile-ud-value\">");
      out.print( order.getPaymentId().getPaymentMethod());
      out.write("</span>\n");
      out.write("                                                                </div>\n");
      out.write("                                                                <div class=\"col-3 d-flex flex-column align-center\">\n");
      out.write("                                                                    <span class=\"profile-ud-label\">Status</span>\n");
      out.write("                                                                    <span class=\"profile-ud-value\">\n");
      out.write("                                                                        ");
      ...
      out.write("                                                                        <th class=\"nk-tb-col\"><span>Qty</span></th>\n");
      out.write("                                                                        <th class=\"nk-tb-col tb-col-md\"><span>Price</span></th>\n");
      out.write("\n");
      ...
      out.write("                                                                    ");
                                                                        ...
                                                                        for (OrderList orderDetails : ordersProductList) {
                                                                            String base64img = Base64.getEncoder().encodeToString(orderDetails.getProductId().getProductimage());
      ...
      out.print( orderDetails.getProductId().getProductname());
      out.write("</span>\n");
      out.write("                                                                            </span>\n");
      out.write("                                                                        </td>\n");
      out.write("                                                                        <td class=\"nk-tb-col\">\n");
      out.write("                                                                            <span class=\"tb-lead\">");
      out.print( orderDetails.getProductId().getCategorycode().getCategoryname());
      out.write("</span>\n");
      out.write("                                                                        </td>\n");
      out.write("                                                                        <td class=\"nk-tb-col\">\n");
      out.write("                                                                            <span class=\"tb-sub\">");
      out.print( orderDetails.getQty());
      out.write("</span>\n");
      out.write("                                                                        </td>\n");
      out.write("                                                                        <td class=\"nk-tb-col tb-col-md\">\n");
      out.write("                                                                            <span class=\"tb-sub\">");
      out.print( orderDetails.getProductId().getPrice());
      out.write(" MYR</span>\n");
      out.write("                                                                        </td>\n");
      out.write("                                                                    </tr><!-- .nk-tb-item -->\n");
      out.write("                                                                    ");
      ...
      out.write("                                                            </div><!-- .nk-block-head -->\n");
      out.write("                                                            <div class=\"profile-ud-list\">\n");
      out.write("                                                                <div class=\"profile-ud-item\">\n");
      out.write("                                                                    <div class=\"profile-ud wider\">\n");
      out.write("                                                                        <span class=\"profile-ud-label\">Name</span>\n");
      out.write("                                                                        <span class=\"profile-ud-value\">");
      ...
      out.write("                                                                <div class=\"profile-ud-item\">\n");
      out.write("                                                                    <div class=\"profile-ud wider\">\n");
      out.write("                                                                        <span class=\"profile-ud-label\">Email</span>\n");
      out.write("                                                                        <span class=\"profile-ud-value\">");
      out.print( order.getCustomerId().getEmail());
      out.write("</span>\n");
      out.write("                                                                    </div>\n");
      out.write("                                                                </div>\n");
      out.write("                                                                <div class=\"profile-ud-item\">\n");
      out.write("                                                                    <div class=\"profile-ud wider\">\n");
      out.write("                                                                        <span class=\"profile-ud-label\">Contact</span>\n");
      out.write("                                                                        <span class=\"profile-ud-value\">");
      out.print( order.getCustomerId().getCustomerContact());
      out.write("</span>\n");
      out.write("                                                                    </div>\n");
      out.write("                                                                </div>\n");
      out.write("                                                                <div class=\"profile-ud-item\">\n");
      ...
      out.write("                                                                        <span class=\"profile-ud-label\">Contact</span>\n");
      out.write("                                                                        <span class=\"profile-ud-value\">");
      out.print( order.getAdressLineOne() + order.getAddressLineTwo() );
      out.write("</span>\n");
      out.write("                                                                    </div>\n");
      out.write("                                                                </div>\n");
      out.write("\n");
      out.write("                                                            </div><!-- .profile-ud-list -->\n");
      out.write("                                                        </div><!-- .nk-block -->\n");
      out.write("\n");
      out.write("                                                    </div><!-- .card-inner -->\n");
      out.write("                                                </form>\n");
      ...
      out.write("                                                                                    window.location.href = \"DeleteOrder?id=");
      out.print( order.getOrderId());
      out.write("\";\n");
      out.write("                                                                                }\n");
      out.write("                                                                            });\n");
      out.write("                                                                        }\n");
      out.write("                                                                        function completeOrder() {\n");
      out.write("                                                                            swal.fire({\n");
      out.write("                                                                                title: 'Are you sure?',\n");
      out.write("                                                                                text: 'You won\\'t be able to revert this!',\n");
      out.write("                                                                                icon: 'warning',\n");
      out.write("                                                                                showCancelButton: true,\n");
      out.write("                                                                                confirmButtonText: 'Complete',\n");
      out.write("                                                                                cancelButtonText: 'Cancel'\n");
      out.write("                                                                            }).then((result) => {\n");
      out.write("                                                                                if (result.isConfirmed) {\n");
      out.write("                                                                                    window.location.href = \"CompleteOrder?id=");
      out.print( order.getOrderId());
      out.write("\";\n");
      out.write("                                                                                }\n");
      out.write("                                                                            });\n");
